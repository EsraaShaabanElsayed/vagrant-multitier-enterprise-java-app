...
sudo apt-get update
sudo apt-get install -y openjdk-8-jdk maven git wget netcat-openbsd
...
# ------------------------------------------------------------------
# 8. CREATE SYSTEMD SERVICE (Optional but recommended for Ubuntu)
# ------------------------------------------------------------------
...
echo "To manage Tomcat service:"
echo "  sudo systemctl start tomcat9"
echo "  sudo systemctl stop tomcat9"
